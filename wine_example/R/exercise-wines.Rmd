...
# fit the random forest to be analyzed (this will take some time) --> stored as RData file in data folder with train and test indices

#rfmod = randomForest(quality ~ ., data = wine_train)
#save(rfmod, train_ind, test_ind,  file = "wine_example/data/model.RData")
```
...
### Exercise 4: 2-way Interactions with Feature 'alcohol'
...
### Exercise 8: Shapely Values - local analysis
...
### Exercise 9: Shapely Values - global analysis
...
### Exercise 10: Further hypotheses
